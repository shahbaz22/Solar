...
def helicity(alpha1,alpha2,alpha3):
    ...
    cb2rat=c2prod/b2prod
    'c3prod and b3prod lower down as they depend on F function'
    c3prod=sig23*F1(a2r2)*y(0,a3r2)-F0(a2r2)*y(1,a3r2)
    b3prod=F0(a2r2)*j(1,a3r2)-sig23*F1(a2r2)*j(0,a3r2)
    #print('b3prod',b3prod)
    #print('c3prod',c3prod)
    ...
    psi0=(2*pi*(R2*b2prod*(F1(a2r2)*dis1/(abs(alpha2)))+R1*ctbdiff))
    ...
    ctb2rat=B2*R2*F1(a2r2)*(1/alpha2-sig23/alpha3)+ctb1rat 
    ...
    k3=k3+(4*pi*B3*B2*R2*ctb2rat*(G0(a3r2)-G0(a3r3)))/abs(alpha3)
    k3=k3*sig3
    #print(k3,'k3')

    helicity=k1+k2+k3
    return helicity
print(helicity(a1,a2,a3))
'''fig=plt.figure()
